...
const seeds: Seed[] = [
  ...
  { slug: "consultation-cost", title: "什么是咨询成本", category: "基础指标", formula: "咨询成本 = 消耗 / 咨询数", summary: "咨询成本只是前端指标，不代表成交质量。", scenario: "用于粗看获取咨询是否太贵。", action: "继续看有效咨询率、到院率和实收 ROI。" },
  ...
  { slug: "roi", title: "什么是实收 ROI", category: "基础指标", formula: "实收 ROI = e看牙实际实收金额 / 广告花费", summary: "实收 ROI 看的是广告花出去的钱有没有通过 e看牙收回来。", scenario: "用于粗看当期回收情况。", action: "继续看项目周期和 e看牙回流，不要把实收 ROI 当利润。" },
  { slug: "gross-profit-roi", title: "什么是实收 ROI", category: "基础指标", formula: "实收 ROI = e看牙实际实收金额 / 广告花费", summary: "当前未配置真实项目成本时，只看实收 ROI。", scenario: "用于判断广告费有没有当期回收。", action: "低于1时需要重点关注，高客单项目要看更长周期。" },
  ...
  { slug: "when-increase-budget", title: "什么情况下该加预算", category: "投放判断", level: "重要", summary: "加预算必须建立在数据质量和实收 ROI 达到参考线之上。", scenario: "考虑扩大投放时。", action: "数据质量合格、有效咨询率达标、到院率达标、成交成本低于目标、实收 ROI 达到参考线，再小幅加预算。" },
  { slug: "when-reduce-budget", title: "什么情况下该降预算", category: "投放判断", summary: "降预算适合持续低质或实收 ROI 偏弱的场景。", scenario: "消耗高但有效线索和成交差时。", action: "有效咨询率低、低质线索多、成交成本高、实收 ROI 低且观察周期足够时再降。" },
  ...
  { slug: "gross-profit-roi-more-important", title: "为什么先看实收 ROI", category: "价格策略", summary: "当前没有真实项目成本时，先看广告费有没有通过 e看牙收回来。", scenario: "ROI看起来不错但不知道成本时。", action: "预算建议先看实收 ROI，后续有真实成本再补利润口径。" },
  ...
  { slug: "views-not-good", title: "为什么播放量高不代表素材好", category: "素材判断", summary: "播放量只是曝光和兴趣，不代表线索质量和成交。", scenario: "短视频曝光很好但有效咨询差时。", action: "结合有效咨询率、成交成本和实收 ROI 判断。" },
  ...
  { slug: "ad-chain", title: "什么是投放链路", category: "投放链路判断", level: "入门", summary: "投放链路就是从曝光、点击、咨询、预约、到院、成交、实收一路看下来。", scenario: "不知道问题卡在哪一步时。", action: "如果曝光少先看预算和出价；如果点击有但咨询少先看页面；如果咨询有但e看牙没有先查承接记录。" },
  { slug: "meituan-chain", title: "美团投放链路怎么看", category: "投放链路判断", summary: "美团先看曝光、点击、商户浏览、电话、在线咨询、团购，再看 e看牙回流。", scenario: "分析美团效果时。", action: "如果商户浏览多但咨询少，就先改页面和购买须知，不要急着加预算。" },
  { slug: "douyin-chain", title: "抖音信息流链路怎么看", category: "投放链路判断", summary: "抖音先看展示、点击、私信/表单，再看有效咨询、到院和实收。", scenario: "抖音素材有流量但没成交时。", action: "如果点击多但有效咨询少，就先换素材方向，不要只看播放量。" },
  { slug: "gdt-chain", title: "腾讯广点通链路怎么看", category: "投放链路判断", summary: "腾讯广点通先看曝光、点击、表单、电话，再看 e看牙来源记录。", scenario: "表单成本便宜但到院少时。", action: "如果表单多但到院少，就先查客服承接和客户质量。" },
  { slug: "amap-chain", title: "高德地图链路怎么看", category: "投放链路判断", summary: "高德重点看电话、导航、地址查看、路线规划和真实到店。", scenario: "地图带来到店客户时。", action: "如果导航多但e看牙没有记录，就先让前台补来源。" },
  { slug: "front-data", title: "什么叫前端数据", category: "投放链路判断", summary: "前端数据是平台后台能看到的曝光、点击、咨询、表单、电话等数据。", scenario: "只看到平台后台数据时。", action: "前端数据只能说明有人看过或问过，不能直接说明成交。" },
  { slug: "backend-return", title: "什么叫后端回流", category: "投放链路判断", summary: "后端回流是 e看牙里记录的预约、到院、成交和实收。", scenario: "判断钱有没有回来时。", action: "如果没有后端回流，不要直接调预算。" },
  { slug: "dont-only-click", title: "为什么不能只看点击", category: "投放链路判断", summary: "点击只说明有人点，不说明有人咨询、到院或成交。", scenario: "点击率很好但效果不好时。", action: "如果点击多但咨询少，就查页面承接、购买须知和咨询入口。" },
  { slug: "dont-only-consult", title: "为什么不能只看咨询", category: "投放链路判断", summary: "咨询多可能是低质线索，最后不一定到院成交。", scenario: "咨询成本低但成交差时。", action: "如果咨询多但到院少，就查有效咨询率和客服承接。" },
  { slug: "dont-only-roi", title: "为什么不能只看 ROI", category: "投放链路判断", summary: "实收 ROI 会受观察周期影响，高客单项目可能不是当周成交。", scenario: "种植、正畸当周实收低时。", action: "如果是高客单项目，就看7-30天甚至15-60天，不要当天停投。" },
  { slug: "find-chain-block", title: "怎么判断问题卡在哪一步", category: "投放链路判断", level: "重要", summary: "按曝光、点击、咨询、预约、到院、成交、实收一步一步排查。", scenario: "不知道该改素材、页面还是客服时。", action: "哪一步突然掉下去，就先处理哪一步，不要一上来就调价。" },
  { slug: "click-no-consult", title: "点击多但咨询少怎么办", category: "投放链路判断", summary: "点击多说明广告有吸引力，咨询少多半是页面或入口没接住。", scenario: "点击不少但咨询少。", action: "先看页面标题、价格表达、购买须知和咨询按钮。" },
  { slug: "consult-no-arrival", title: "咨询多但到院少怎么办", category: "投放链路判断", summary: "咨询多但到院少，通常是线索质量或客服邀约问题。", scenario: "咨询很多但门诊没人来。", action: "先查有效咨询率、预约率、提醒话术和到院理由。" },
  { slug: "arrival-no-deal", title: "到院多但成交少怎么办", category: "投放链路判断", summary: "到院多但成交少，重点看医生方案、价格落差、信任和付款压力。", scenario: "门诊来了人但成交少。", action: "先复盘未成交原因，不要立刻怪投放。" },
  { slug: "deal-low-paid", title: "成交有但实收低怎么办", category: "投放链路判断", summary: "成交有但实收低，可能是活动价太低、只成交引流项目或收费没录完整。", scenario: "成交数不差但钱没回来。", action: "先查实收金额、成交项目和活动机制，再看是否调整价格表达。" },
  ...
  { slug: "can-adjust-budget-today", title: "如何判断今天能不能调预算", category: "每日操作流程", level: "重要", summary: "调预算前先确认数据质量、样本量、观察周期和实收 ROI。", scenario: "准备调预算时。", action: "数据质量合格、样本足够、周期足够、实收 ROI 达到参考线后再人工确认。" },
